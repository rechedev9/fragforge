...
// Canonical download facts, verified against the live GitHub Release v0.2.8.
// The href must remain byte-for-byte this string.
const DOWNLOAD_URL =
  "https://github.com/rechedev9/fragforge/releases/download/v0.2.8/FragForge.Studio.Setup.0.2.8.exe";
      ...
      >
        ...
        <div className="relative z-10 flex max-w-3xl flex-col items-center gap-7">
          ...
          <p className="font-mono text-sm tracking-[0.08em] text-muted-foreground">
            v0.2.8 <span className="text-primary/70">·</span> 124 MB{" "}

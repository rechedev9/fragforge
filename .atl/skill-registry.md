...
- /home/reche/.pi/agent/skills
- /home/reche/.agents/skills
- /home/reche/.config/opencode/skills
- /home/reche/.claude/skills
- /home/reche/.gemini/antigravity/skills
- /home/reche/.cursor/skills
- /home/reche/.copilot/skills
- /home/reche/.codex/skills
- /home/reche/.codeium/windsurf/skills
- /home/reche/.qwen/skills
- /home/reche/.kiro/skills
- /home/reche/.openclaw/skills
...
### branch-pr
- Path: /home/reche/.claude/skills/branch-pr/SKILL.md
...
### chained-pr
- Path: /home/reche/.claude/skills/chained-pr/SKILL.md
...
- Path: /home/reche/.claude/skills/cognitive-doc-design/SKILL.md
...
### comment-writer
- Path: /home/reche/.claude/skills/comment-writer/SKILL.md
...
### go-testing
- Path: /home/reche/.claude/skills/go-testing/SKILL.md
...
### imagegen
- Path: /home/reche/.codex/skills/.system/imagegen/SKILL.md
...
### issue-creation
- Path: /home/reche/.claude/skills/issue-creation/SKILL.md
...
### judgment-day
- Path: /home/reche/.claude/skills/judgment-day/SKILL.md
...
### openai-docs
- Path: /home/reche/.codex/skills/.system/openai-docs/SKILL.md
- Trigger: Use when the user asks how to build with OpenAI products or APIs and needs up-to-date official documentation with citations, help choosing the latest model for a use case, or model upgrade and prompt-upgrade guidance; prioritize OpenAI docs MCP tools, use bundled references only as helper context, and restrict any fallback browsing to official OpenAI domains.
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### pdf-reader
- Path: /home/reche/.claude/skills/pdf-reader/SKILL.md
- Trigger: Trigger: read PDF, extract PDF, inspect PDF, leer PDF, extraer PDF, OCR scan, attachments, form fields. Inspect and extract content from PDF files via poppler + Python libs (pypdf, pdfplumber, PyMuPDF, pytesseract).
- Rules:
  - ALWAYS run an inventory pass before extracting anything — never guess the PDF's nature.
  - Text-extract first; rasterize pages only when figures, layout, equations, or garbled output demand it.
  - A rasterized page costs ~1.6k tokens vs ~200–400 for text — do NOT rasterize entire documents blindly.
  - For scanned PDFs (empty `pdftotext` output), use OCR via `pytesseract`.
  - `pdfimages` extracts raster image data ONLY — vector charts from matplotlib/Excel will NOT appear. Rasterize the page instead.
  - Sanitize any user-controlled filename before writing (e.g., attachment names via `os.path.basename`).
  - If text extraction is garbled, diagnose with `pdffonts` before assuming the PDF is broken.
  - Goal: First action
  - Summarize / find facts in text PDF: `pdftotext` or `pypdf`
  - Multi-column / preserve layout: `pdftotext -layout`
  - Tables: `pdfplumber.extract_tables()`
  - Charts, diagrams, equations, scanned pages: `pdftoppm -jpeg -r 150` → Read image
  - Embedded raster images: `pdfimages -png` (filter by file size to skip empty masks)
  - Attachments (spreadsheets, embedded files): `pdfdetach -saveall`
  - Form field values: `pypdf.PdfReader.get_fields()` (all types) or `get_form_text_fields()` (text only)

### plugin-creator
- Path: /home/reche/.codex/skills/.system/plugin-creator/SKILL.md
...
### skill-creator
- Path: /home/reche/.claude/skills/skill-creator/SKILL.md
...
### skill-installer
- Path: /home/reche/.codex/skills/.system/skill-installer/SKILL.md
...
### use-railway
- Path: /home/reche/.agents/skills/use-railway/SKILL.md
- Trigger: >
- Rules:
  - No compact rules declared; delegators should load the full skill file before direct work, or pass an explicit fallback path only when Project Standards cannot be injected.

### work-unit-commits
- Path: /home/reche/.claude/skills/work-unit-commits/SKILL.md

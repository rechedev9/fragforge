"use strict";
{
    const id = "zackvideo/e2-multi-segment";
    ...
    const schedule = [
        ...
        { tick: 22022, key: "camera-seg-001", cmd: "spec_mode 1; spec_player_by_accountid 188721128" },
        { tick: 22080, key: "hide-demoui", cmd: "demoui" },
        { tick: 22086, key: "record-start-seg-001", cmd: "mirv_streams record start" },
        { tick: 22868, key: "record-end-seg-001", cmd: "mirv_streams record end" },

        { tick: 22900, key: "seek-seg-002", cmd: "demo_gototick 31618" },
        { tick: 31682, key: "camera-seg-002", cmd: "spec_mode 1; spec_player_by_accountid 188721128" },
        ...
        { tick: 32300, key: "seek-seg-003", cmd: "demo_gototick 34458" },
        { tick: 34522, key: "camera-seg-003", cmd: "spec_mode 1; spec_player_by_accountid 188721128" },
        { tick: 34586, key: "record-start-seg-003", cmd: "mirv_streams record start" },
        { tick: 35098, key: "record-end-seg-003", cmd: "mirv_streams record end" },

        { tick: 35200, key: "disconnect", cmd: "disconnect" },
        { tick: 35300, key: "quit", cmd: "quit" }
    ];

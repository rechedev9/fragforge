...
| FF-SEC-009 | Open; does not block checksummed releases | The current public installer flow remains unsigned and publishes verified SHA-256 checksums. Authenticode enforcement was removed until a publicly trusted signing identity is available because the available development certificate is not suitable for public distribution. |
